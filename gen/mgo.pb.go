...
var file_mgo_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x6c, 0x0a, 0x10, 0x50,
	...
	0x69, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x6f, 0x72, 0x74, 0x66, 0x6f, 0x6c, 0x69, 0x6f, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x1b, 0x2e, 0x6d,
	0x67, 0x6f, 0x2e, 0x70, 0x6f, 0x72, 0x74, 0x66, 0x6f, 0x6c, 0x69, 0x6f, 0x2e, 0x76, 0x31, 0x2e,
	0x50, 0x6f, 0x72, 0x74, 0x66, 0x6f, 0x6c, 0x69, 0x6f, 0x32, 0xcd, 0x04, 0x0a, 0x11, 0x53, 0x65,
...
var file_mgo_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_mgo_proto_goTypes = []interface{}{
	...
	(*TriggerQuoteUpdateRequest)(nil),  // 10: mgo.portfolio.v1.TriggerQuoteUpdateRequest
	(*TriggerQuoteUpdateResponse)(nil), // 11: mgo.portfolio.v1.TriggerQuoteUpdateResponse
...
var file_mgo_proto_depIdxs = []int32{
	...
	12, // 1: mgo.portfolio.v1.ListedSecurity.latest_quote_timestamp:type_name -> google.protobuf.Timestamp
	...
	13, // 5: mgo.portfolio.v1.UpdateSecurityRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	10, // 12: mgo.portfolio.v1.SecuritiesService.TriggerSecurityQuoteUpdate:input_type -> mgo.portfolio.v1.TriggerQuoteUpdateRequest
	1,  // 13: mgo.portfolio.v1.PortfolioService.CreatePortfolio:output_type -> mgo.portfolio.v1.Portfolio
	5,  // 14: mgo.portfolio.v1.SecuritiesService.ListSecurities:output_type -> mgo.portfolio.v1.ListSecuritiesResponse
	2,  // 15: mgo.portfolio.v1.SecuritiesService.GetSecurity:output_type -> mgo.portfolio.v1.Security
	2,  // 16: mgo.portfolio.v1.SecuritiesService.CreateSecurity:output_type -> mgo.portfolio.v1.Security
	2,  // 17: mgo.portfolio.v1.SecuritiesService.UpdateSecurity:output_type -> mgo.portfolio.v1.Security
	14, // 18: mgo.portfolio.v1.SecuritiesService.DeleteSecurity:output_type -> google.protobuf.Empty
	11, // 19: mgo.portfolio.v1.SecuritiesService.TriggerSecurityQuoteUpdate:output_type -> mgo.portfolio.v1.TriggerQuoteUpdateResponse
...
func file_mgo_proto_init() {
	...
	file_mgo_proto_msgTypes[2].OneofWrappers = []interface{}{}
