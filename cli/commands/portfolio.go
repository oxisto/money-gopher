...
var PortfolioCmd = &cli.Command{
	...
	Commands: []*cli.Command{
		...
		},
		{
			...
			Action: ListPortfolioCmd,
			Flags:  []cli.Flag{},
		},
		{
			Name:   "show",
			Usage:  "Shows details about one portfolio",
			Action: ShowPortfolioCmd,
			Flags: []cli.Flag{
...
func ListPortfolioCmd(ctx context.Context, cmd *cli.Command) error {
...
func CreatePortfolioCmd(ctx context.Context, cmd *cli.Command) error {
	s := mcli.FromContext(ctx)
...
func ShowPortfolioCmd(ctx context.Context, cmd *cli.Command) error {
	s := mcli.FromContext(ctx)
...
func CreateTransactionCmd(ctx context.Context, cmd *cli.Command) error {
	s := mcli.FromContext(ctx)
	var req = connect.NewRequest(&portfoliov1.CreatePortfolioTransactionRequest{
		Transaction: &portfoliov1.PortfolioEvent{
			...
			Type:          eventTypeFrom(cmd.String("type")), // eventTypeFrom(cmd.Type)
...
// ImportTransactionsCmd imports transactions from a CSV file
func ImportTransactionsCmd(ctx context.Context, cmd *cli.Command) error {
	s := mcli.FromContext(ctx)
	// Read from args[1]
