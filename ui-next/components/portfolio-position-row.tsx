      ...
      <tr>
        ...
        <td className="hidden whitespace-nowrap px-3 py-2 text-right text-sm lg:table-cell">
          <div className="text-gray-500">
            {currency(position.purchasePrice)}
          </div>
          <div className="text-gray-400">
            {currency(position.purchaseValue)}
          </div>
        </td>
        <td className="hidden whitespace-nowrap px-3 py-2 text-right text-sm sm:table-cell">
          <div className="text-gray-500">{currency(position.marketPrice)}</div>
          <div className="text-gray-400">{currency(position.marketValue)}</div>
        </td>
        <td
        ...
        >
          ...
          <div className="pr-4">{currency(position.profitOrLoss)}</div>
        </td>
      </tr>
    );
  }
